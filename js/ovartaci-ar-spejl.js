...
const identiteter = [
...

    {
      ...
      Kunster: "Ovartaci",
      Årstal: "",
      Beskrivelse: "Jeg begyndte som en paradisfugl, og under min flugt blev jeg til sidst forvandlet til en måge og ankom til Grønland, men det er mange år siden.",
      Billede: "src/images/fuglen.png"
    },

    {
      ...
      Kunster: "Ovartaci",
      Årstal: "",
      Beskrivelse: "Drager i Ovartacis kosmologi fungerede ikke som monstre, men som spirituelle symboler på lykke, værdighed, transformation og personlig frihed. Personlig frihed: En flugtvej og et sindbillede på at kunne bryde ud af psykiatriens fysiske og mentale rammer. Værdighed og styrke: Dragen stod for stolthed og livskvalitet. Transformation: En sjælelig forvandling, der ofte blev kædet sammen med genfødsel og kvindens psyke.",
      Billede: "src/images/dragen.png"
    },

    {
      ...
      Kunster: "Ovartaci",
      Årstal: "",
      Beskrivelse: "'Det er et menneske i tigerskikkelse eller en tiger, der rejser sig på bagbenene, men se, den har jo tæer som mennesket og ikke som en tiger. Det er et menneske i tigerskikkelse. Jeg var selv tiger og blev forvandlet til menneske'. Sådan fortæller Ovartaci i samtalebogen 'Ovartaci - Pictures, Thoughts and Visions of an Artist'. Netop denne flydende tilstand mellem dyr og mennesker er kendetegnende for Ovartaci.",
    Billede: "src/images/tigeren.png"
    },

    {
      ...
      Billede: "src/images/ovartaci.png"
    },
  ];
